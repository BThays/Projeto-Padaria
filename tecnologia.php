...
<html lang="pt-br">
    ...
    <body>
        ...
        <div id="main"> <!-- Caixa Principal -->
            <section id="section_tecnologia"> <!-- 1° caixa slider-->  
              
            </section>
               
               <div id="conteudo_tecnologia">
                   
                   <div class="box_tecnologia_photo">
                       
                    </div>
                     
                     
                    <div id="box_tecnologia">
                       <h2>Nosso Ambiente de Tecnologia!</h2>
