...
<html lang="pt-br">
    ...
    <body>
        ...
        <div id="box_transparencia_loja"> 
        </div>
                
            <div id="transp_element_loja">

                <div id="conteudo_loja">
                    <h1 id="title_loja">Localização</h1>
                    <p id="text_loja">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer eu velit ut est faucibus sollicitudin. Nunc vel iaculis elit. .</p>
                </div>
            </div>
        </div>
